-- Research Tool Database Schema - FIXED VERSION
-- Handles existing policies gracefully

-- Drop existing policies first to avoid conflicts
DROP POLICY IF EXISTS "Team members can access company research" ON public.company_research;
DROP POLICY IF EXISTS "Team members can access website analysis" ON public.website_analysis;
DROP POLICY IF EXISTS "Team members can access company intelligence" ON public.company_intelligence;
DROP POLICY IF EXISTS "Team members can access competitor analysis" ON public.competitor_analysis;
DROP POLICY IF EXISTS "Team members can access research sources" ON public.research_sources;

-- Drop existing tables if they exist (in correct order)
DROP TABLE IF EXISTS public.research_sources CASCADE;
DROP TABLE IF EXISTS public.competitor_analysis CASCADE;
DROP TABLE IF EXISTS public.company_intelligence CASCADE;
DROP TABLE IF EXISTS public.website_analysis CASCADE;
DROP TABLE IF EXISTS public.company_research CASCADE;
