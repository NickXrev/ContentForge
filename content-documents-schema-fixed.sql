...
DROP POLICY IF EXISTS "Team members can read team documents" ON content_documents;
DROP POLICY IF EXISTS "Team members can create documents" ON content_documents;
DROP POLICY IF EXISTS "Team members can update team documents" ON content_documents;
DROP POLICY IF EXISTS "Team members can delete team documents" ON content_documents;
